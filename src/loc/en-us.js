define([], function() {
  return {
    ...
    NavigationWebPartPlaceholderText:
      "This text is visible in Edit mode only to allow easier edit of web part properties.",
    NavAnchorGroupName: "Anchor Settings",
    ShowTitleFieldLabel: "Show anchor title in Read mode",
    AnchorTitlePlaceholder:
      "Enter a title to be displayed in the page navigation"
  };
});
